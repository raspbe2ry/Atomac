...
// our square size
function calculateSquareSize(boardType) {
...
function buildBoardContainer() {
  ...
  html += '<div class="' + CSS.sparePieces + '"><div class="' + CSS.sparePiecesLeft + '"></div></div>';

  html += '<div class="' + CSS.board + '"></div>';

  html += '<div class="' + CSS.sparePieces + '"><div class="' + CSS.sparePiecesRight + '"></div></div>';
...
widget.resize = function(boardType) {
  ...
  let sparePiecesStyle = {
      ...
      height: (SQUARE_SIZE * 8 + 4) + 'px'
  };
  sparePiecesLeftEl.css(sparePiecesStyle);
  sparePiecesRightEl.css(sparePiecesStyle);
