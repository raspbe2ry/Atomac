...
function expandConfig() {
  ...
  // ako nema spare nizova figura sa strane table, setuje ih na null
...
function buildPieceImgSrc(piece) {
  piece = piece.substring(0, 2); // svodim sa npr. 'bPx' na 'bP'
...
// prepravljeno tako da radi za niz figura
