...
{
    AddRowForRule("Insert check", "check");
    ...
    AddRowForRule("Insert checkmate", "checkMate");
    ...
    AddRowForRule("Insert pawn on first line", "pawnFirstLine");
    ...
    AddRowForRule("Insert pawn on last line", "pawnLastLine");
    ...
    AddRowForRule("Insert piece on last line", "figureLastLine");
