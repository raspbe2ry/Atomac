...
namespace Atomac.Controllers
{
    public class TeamsController : Controller
    {
        ...
        {
            var teams = db.Teams.Include(t => t.Capiten).Include(t => t.TeamMember);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Activity,Points,CapitenId,TeamMemberId")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Activity,Points,CapitenId,TeamMemberId")] Team team)
        {
            if (ModelState.IsValid)
            {
