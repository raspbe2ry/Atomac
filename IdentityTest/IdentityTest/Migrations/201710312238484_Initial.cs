namespace IdentityTest.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Klasas", "TeamMemberId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Klasas", "CapitenId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Klasas", new[] { "TeamMemberId" });
            DropIndex("dbo.Klasas", new[] { "CapitenId" });
